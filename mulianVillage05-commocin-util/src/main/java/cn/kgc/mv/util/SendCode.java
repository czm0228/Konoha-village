...
public class SendCode {
    ...
    private static final String
            APP_KEY="ad5046097762a819fb36cd256002eaa9";
    //网易云信分配的密钥，请替换你在管理后台应用下申请的appSecret
    private static final String APP_SECRET="aab60da4dc8a";
    //随机数
    private static final String NONCE="123456";
    //短信模板ID
    private static final String TEMPLATEID="14872178";
    /*//手机号
    ...
    public static String send( String mobile) throws Exception {
       ...
       /* System.out.println("状态码为:"+code);*/
        if("200".equals(code)){
        	 ...
        	 String verificationCode= JSON.parseObject(jsonCode).getString("obj");
